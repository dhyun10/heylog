package com.myblog.heylog.common;
...
public class MyUtil {
	...
	public String paging(int current_page, int total_page, String list_url) {
		...
		sb.append("#paginate .curBox {border:1px solid black; background: black; color:#fff; font-weight:bold;height:28px;padding:4px 7px 4px 7px;margin-left:3px;line-height:normal;vertical-align:middle;}");
		sb.append("#paginate .numBox {border:1px solid black;height:28px;font-weight:bold;text-decoration:none;padding:4px 7px 4px 7px;margin-left:3px;line-height:normal;vertical-align:middle;}");
		sb.append("</style>");
